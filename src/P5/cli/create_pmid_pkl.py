...
@click.option("--root", "root_dir", required=True, type=click.Path(exists=True, file_okay=False),
              help="Directory to scan")
@click.option("--pattern", default="**/*.pdf", help="Glob (relative to root) for files to scan (default: **/*.pdf)")
@click.option("--out", "out_file", required=True, type=click.Path(),
