...
if __name__ == "__main__":
    ...
    print("\n=== Final Path Summary ===")
    print("Created the PDF inputs folder:                               %s" % paths.pdf_input_directory)
    print("Created the ground truth folder:                             %s" % paths.ground_truth_notebooks_directory)
    print("Created the PATH for the CSV of `phenopacket-store`:         %s" % paths.dataset_csv_file_path)
    print("Created the PATH for the experimentally generated files:     %s" % paths.experimental_data_root_directory)
    print("Created the LLM outputs folder:                              %s" % paths.llm_raw_output_directory)
    print("Created the validated JSONs folder:                          %s" % paths.validated_jsons_output_directory)
    print("Created the evaluation report path:                          %s" % paths.evaluation_report_file_path)
