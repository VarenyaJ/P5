...
Definitions:
   ...
   - false_negative = a ground-truth label that the model failed to predict
"""
...
class PhenotypeEvaluator:
   ...
   def check_phenotypes(
       ...
       ground_truth_phenotypes
           A Phenopacket object whose `list_phenotypes()` method returns the authoritative list of true labels.
       """
